...
const matchResult  =  {
    ...
    test('when multiple blogs, returns the one with most likes', () => {
        // arrange - create a blogs array
        const result = listHelper.favoriteBlog(listWithMoreBlog)
            assert.deepStrictEqual(result,matchResult)
        // act - call favoriteBlog(blogs)
        // assert - check the result matches expected blog
    })
